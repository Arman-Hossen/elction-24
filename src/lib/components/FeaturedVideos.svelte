<script>
	import cover from '$lib/images/bg.svg';
...
<div id="photo-album" class="bg-cover mt-6 pb-20" style="background-image: url('{cover}') ">
	<div class="container mx-auto">
		<div class="flex justify-between pt-14 px-4">
			<h1 class="font-bold text-xl md:text-4xl text-[#ffffff]">Photos / Featured Videos</h1>
			<button class="font-medium text-base text-[#ffffff] hover:text-[#FF00A5]"
				><a href="https://www.unb.com.bd/subcategory/20/Cricket" target="_blank">See All</a></button
			>
		</div>
